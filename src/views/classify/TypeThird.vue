      ...
      v-card-text
        v-container
          v-row
            ...
            v-col(cols='12')
              v-select(v-model='edit_dialog_data.second' :items='edit_dialog_data.second_items' label='分類2')
            v-col(cols='12')
              v-text-field(label='分類3' v-model='edit_dialog_data.third')
      v-card-actions
        v-spacer
      ...
      v-card-text
        v-container
          v-row
            ...
            v-col(cols='12')
              v-select(v-model='add_dialog_data.second' :items='add_dialog_data.second_items' label='分類2')
            v-col(cols='12')
              v-text-field(label='分類3' v-model='add_dialog_data.third')
      v-card-actions
        v-spacer
...
export default {
  ...
  data() {
    return {
      ...
      add_dialog: false,
      add_dialog_data: { first_items:[{text:"豆乳醬",value:"豆乳醬"}],first:"豆乳醬" ,third:"大包裝",second_items:[{text:"豆乳醬",value:"豆乳醬"}],second:"豆乳醬"},   
      edit_dialog: false,
      edit_dialog_data: { first_items:[{text:"豆乳醬",value:"豆乳醬"}] ,first:"豆乳醬",third:"大包裝",second_items:[{text:"豆乳醬",value:"豆乳醬"}],second:"豆乳醬"},  
